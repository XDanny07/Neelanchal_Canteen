...
<head>
    ...
    <title>{{ config('app.name', 'Neelanchal Canteen') }}</title>
...
<body>
    <div id="app" class="min-h-screen flex flex-col bg-red-100">
        <nav class="navbar navbar-expand-md navbar-light bg-red-600 shadow-sm">
            <div class="container">
                <a class="navbar-brand font-bold text-white text-xl" href="{{ url('/') }}">
                    <!-- {{ config('app.name', 'Neelanchal Canteen') }} -->
                    {{ __('Neelanchal Canteen') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                            ...
                            <a class="nav-link" href="{{ url('cart') }}">
                                ...
                                <div class="absolute top-0.5 right-0">
                                    @if (session('cart') != null)
                                        <span class="text-xs text-white font-bold rounded-lg px-1 bg-red-400 opacity-80">
                                            {{count(session('cart'))}}
                                        </span>
                                    @endif
                                </div>
                        ...
                        @if (Route::has('login'))
                        <li class="nav-item">
                            <a class="nav-link font-bold text-white" href="{{ route('login') }}">{{ __('Login') }}</a>
                        </li>
                        <!-- disabled link for spacing -->
                        <li class="nav-item disabled">
                            <a class="nav-link" href=""><span class="sr-only"></a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link font-bold text-white" href="{{ route('register') }}">{{ __('Register') }}</a>
                        </li>
